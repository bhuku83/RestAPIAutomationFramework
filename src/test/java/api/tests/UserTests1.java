...
public class UserTests1 {
    ...
    public void testPostUser(){
        ...
        Response response= UserEndPoints1.createUsers(userPayload);
    ...
    public void testGetUserByName(){
        ...
        Response response= UserEndPoints1.readUsers(this.userPayload.getUsername());
        response.then().log().all();
    ...
    public void testUserUpdateUserByFirstName(){
        ...
        Response response = UserEndPoints1.updateUsers(this.userPayload.getUsername(),userPayload);

        response.then().log().body();
        Assert.assertEquals(response.getStatusCode(),200);

        Response responseAfterUpdate= UserEndPoints1.readUsers(this.userPayload.getUsername());
    ...
    public void testDeleteUserByUserName(){
        ...
        Response response = UserEndPoints1.deleteUsers(this.userPayload.getUsername());
